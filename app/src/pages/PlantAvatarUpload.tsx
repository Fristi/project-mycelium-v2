...
import { PlantProfile, PlantProfileVariables } from "../backend-client/api";
import { useParams } from "react-router";
import { createRetriever } from "../api";
import { useAuth } from "../AuthContext";
import { useNavigate } from "react-router-dom";

interface PlantProfileVariablesDisplayProps {
  variables: PlantProfileVariables;
}

const PlantProfileVariablesDisplay: React.FC<PlantProfileVariablesDisplayProps> = ({ variables }) => {
  return (
