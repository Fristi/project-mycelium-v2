...
async fn main(_spawner: Spawner) {
    ...
    /// BLE SECTION
    // let message: Arc<Mutex<NoopRawMutex, String<64>>> = Arc::new(Mutex::<NoopRawMutex, _>::new(
    //     String::from_str("Hello, Ferris!").unwrap(),
    // ));
    ...
    // _spawner.spawn(ble_embassy_task(esp_wifi_ctrl, bluetooth, message.clone())).unwrap();
...
//     bt: BT,
//     mutex: Arc<Mutex<NoopRawMutex, String<64>>>,
// ) {
