...
pub const MEASUREMENT_SERVICE_UUID: [u8; 16] = [
    0xBC, 0x9A, 0x78, 0x56, 0x34, 0x12, 0x34, 0x12, 
    0x34, 0x12, 0x78, 0x56, 0x34, 0x12, 0x00, 0x00
];
pub const MEASUREMENT_CHARACTERISTIC_UUID: [u8; 16] = [
    0x76, 0x98, 0xBA, 0xDC, 0xFE, 0x21, 0x21, 0x43, 
    0x21, 0x43, 0x21, 0x43, 0x21, 0x43, 0x00, 0x00
];

// BLE Current Time Service (standard BLE service)
pub const CURRENT_TIME_SERVICE_UUID: [u8; 16] = [
    0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, 
    0x00, 0x10, 0x00, 0x00, 0x05, 0x18, 0x00, 0x00
];
pub const CURRENT_TIME_CHARACTERISTIC_UUID: [u8; 16] = [
    0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80, 
